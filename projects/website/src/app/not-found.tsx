    ...
    <div className="from-background via-background to-accent-deep/20 min-h-screen w-full bg-linear-to-br">
      ...
      <div className="relative flex min-h-screen w-full flex-col items-center justify-center px-4 text-center">
        <div className="z-10 flex flex-col items-center gap-8">
          <div className="from-primary to-accent-secondary animate-gradient-slow bg-linear-to-r bg-size-[200%_200%]
          bg-clip-text text-8xl font-bold text-transparent sm:text-9xl lg:text-[12rem]">
            404
          </div>

          <div className="flex flex-col items-center gap-4">
            <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl">Page Not Found</h1>
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <SimpleLink href="/">
              <Button
                ...
                group relative h-12 overflow-hidden rounded-xl border-2 px-8 backdrop-blur-xs transition-all duration-300"
              >
                <div className="from-primary/10 to-accent-secondary/10 absolute inset-0 bg-linear-to-r opacity-0
            ...
            <SimpleLink href="/search">
              <Button
                size="lg"
                variant="outline"
                className="border-primary/30 bg-primary/5 text-primary hover:border-primary/50 hover:bg-primary/10 group relative
                h-12 overflow-hidden rounded-xl border-2 px-8 backdrop-blur-xs transition-all duration-300"
              >
                <div className="from-primary/10 to-accent-secondary/10 absolute inset-0 bg-linear-to-r opacity-0 transition-opacity
