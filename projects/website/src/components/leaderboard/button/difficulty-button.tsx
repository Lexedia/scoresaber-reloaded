  ...
  return (
    <SimpleLink href={`/leaderboard/${id}`}>
      ...
      <Button
        ...
        variant="ghost"
        className={cn(
          'difficulty-button-hover flex h-10 flex-col items-center justify-center rounded-b-none border-none',
          ' px-(--spacing-md) py-(--spacing-sm) text-xs text-white transition-all duration-200',
