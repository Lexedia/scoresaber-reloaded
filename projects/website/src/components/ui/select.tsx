...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      className={cn(
        `border-border ring-offset-background placeholder:text-muted-foreground focus:ring-ring hover:border-primary/50 bg-muted
      flex h-9 w-full cursor-pointer items-center justify-between rounded-md border px-3 py-2 text-sm
      whitespace-nowrap transition-colors duration-200 focus:ring-1 focus:outline-hidden disabled:cursor-not-allowed
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        className={cn(
          ...
          data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 border-border
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      className={cn(
        `focus:bg-accent focus:text-accent-foreground relative flex w-full cursor-pointer items-center rounded-xs
        py-1.5 pr-8 pl-2 text-sm select-none focus:outline-hidden data-disabled:pointer-events-none
