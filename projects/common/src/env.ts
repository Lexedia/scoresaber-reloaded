...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_ACCSABER_DOMAIN: z.string().optional(),
    NEXT_PUBLIC_BEATSAVER_DOMAIN: z.string().optional(),
    ...
    NEXT_PUBLIC_CHROVIEWER_URL: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_BEATLEADER_DOMAIN: process.env.NEXT_PUBLIC_BEATLEADER_DOMAIN ?? 'beatleader.com',
    NEXT_PUBLIC_ACCSABER_DOMAIN: process.env.NEXT_PUBLIC_ACCSABER_DOMAIN ?? 'accsaberreloaded.com',
    NEXT_PUBLIC_BEATSAVER_DOMAIN: process.env.NEXT_PUBLIC_BEATSAVER_DOMAIN ?? 'beatsaver.com',
    ...
    NEXT_PUBLIC_CHROVIEWER_URL: process.env.NEXT_PUBLIC_CHROVIEWER_URL ?? 'https://chroviewer.lexedia.moe',
